...
public:
  BleHeadTracker(std::string deviceName = "ESP32 BLE Head Tracker", std::string deviceManufacturer = "Espressif", uint8_t batteryLevel = 100);
  void begin(void);
  void end(void);
  void setAxes(signed char roll = 0, signed char pitch = 0, signed char yaw = 0);
